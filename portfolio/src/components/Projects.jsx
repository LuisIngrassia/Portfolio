    ...
    >
        ...
        <div className="flex items-center gap-2">
          {project.github && (
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/60 hover:text-white hover:border-white/30 transition-all text-xs"
            >
              <GitHubIcon />
              {t('projects.viewCode')}
            </a>
          ...
          {project.link && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-purple-600/20 border border-purple-500/30 text-purple-300 hover:bg-purple-600/30 hover:text-white transition-all text-xs"
            >
              <ExternalLinkIcon />
              {t('projects.viewLive')}
            </a>
      ...
      <div className="flex flex-wrap gap-2 mt-auto">
        {project.tags.map((tag) => (
          <span
            key={tag}
            className="px-3 py-1 rounded-full bg-white/[0.05] border border-white/10 text-white/50 text-xs"
          >
            {tag}
          </span>
        ))}
